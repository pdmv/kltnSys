...
<div class="container">
    <form action="${pageContext.request.contextPath}/admins" method="get" class="row g-2 mb-3 justify-content-center">
        ...
        <div class="col-md-3 d-flex align-items-center">
            <button type="submit" class="btn btn-primary" style="height: calc(3.5rem + 2px);">Tìm kiếm</button>
            <a href="<c:url value='/admins/add' />" class="btn btn-success" style="height: calc(3.5rem + 2px); margin-left: 10px;">Thêm</a>
        </div>
    </form>
</div>
