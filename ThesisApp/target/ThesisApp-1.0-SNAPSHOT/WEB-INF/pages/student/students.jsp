<%-- 
    Document   : students
    Created on : May 29, 2024, 4:51:36 PM
...
<h2 class="text-center m-2">Quản lý <strong>SINH VIÊN</strong></h2>

<div class="container">
    <form action="${pageContext.request.contextPath}/admins/students" method="get" class="row g-2 mb-3 justify-content-center">
        ...
        <div class="col-md-7 col-12">
            ...
            <div class="form-floating" id="majorInput" style="display: none;">
                <select id="majorKw" name="kw" class="form-control">
                    <c:forEach items="${majors}" var="major">
                        <option value="${major.id}">${major.name}</option>
                    </c:forEach>
                </select>
                <label for="majorKw">Ngành đào tạo</label>
            </div>
        ...
        <div class="col-md-3 col-12 d-flex align-items-center">
            ...
            <a href="<c:url value='/admins/students' />" class="btn btn-outline-dark" style="margin-left: 10px;">Tất cả</a>
            <a href="<c:url value='/admins/students/add' />" class="btn btn-outline-dark" style="margin-left: 10px;">Thêm</a>
        </div>
    </form>
</div>
    ...
    <tbody>
        <c:forEach items="${students}" var="a">
            <tr>
                ...
                <td>
                    <a class="btn btn-outline-dark" href="<c:url value="/admins/students/${a.id}" />">Cập nhật</a>
...
<script>
    document.getElementById('type').addEventListener('change', function() {
        ...
        if (this.value === 'faculty') {
            ...
            nameInput.style.display = 'none';
            facultyInput.style.display = 'none';
            document.getElementById('majorKw').setAttribute('name', 'kw');
        }
    });
</script>
