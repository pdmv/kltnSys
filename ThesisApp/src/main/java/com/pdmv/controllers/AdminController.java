...
//            model.addAttribute("majors", this.majorService.getMajors(null));
    ...
    public @ResponseBody
    List<Major> getMajorsByFaculty(@RequestParam Map<String, String> params) {
    ...
    public @ResponseBody
    List<Class> getClassByMajor(@RequestParam Map<String, String> params) {
        String type = params.get("type");
        String kw = params.get("kw");
    ...
    @GetMapping("/stats/thesis-scores")
    public String thesisScoreStats(Model model,
            @RequestParam(value = "facultyId", required = false) Integer facultyId) {
        model.addAttribute("faculties", this.facultyService.getFaculties(""));

        if (facultyId != null) {
            model.addAttribute("selectedFacultyId", facultyId);
            model.addAttribute("avgScores", this.statsService.getAvgThesisScoresBySchoolYear(facultyId));
        }

        return "thesis-score-stats";
    }

    @GetMapping("/stats/thesis-count-by-major")
    public String thesisCountByMajorStats(Model model,
            @RequestParam(value = "facultyId", required = false) Integer facultyId,
        ...
        if (facultyId != null) {
            ...
            model.addAttribute("thesisCounts", this.statsService.getThesisCountByMajor(facultyId, schoolYearId));
        }

        return "thesis-count-by-major-stats";
    }
}
