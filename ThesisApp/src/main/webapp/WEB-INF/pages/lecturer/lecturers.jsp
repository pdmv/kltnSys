<%-- 
    Document   : lecturers
    Created on : May 29, 2024, 4:15:19 PM
...
<h2 class="text-center m-2">Quản lý <strong>GIẢNG VIÊN</strong></h2>

<div class="container">
    <form action="${pageContext.request.contextPath}/admins/lecturers" method="get" class="row g-2 mb-3 justify-content-center">
        ...
        <div class="col-md-3 col-12 d-flex align-items-center">
            ...
            <a href="<c:url value='/admins/lecturers' />" class="btn btn-outline-dark" style="margin-left: 10px;">Tất cả</a>
            <a href="<c:url value='/admins/lecturers/add' />" class="btn btn-outline-dark" style="margin-left: 10px;">Thêm</a>
        </div>
    </form>
</div>
...
<table class="table table-hover">
    ...
    <tbody>
        <c:forEach items="${lecturers}" var="a">
            <tr>
                <td>${a.id}</td>
                <td>${a.lastName}</td>
                <td>${a.firstName}</td>
                ...
                <td>
                    <a class="btn btn-outline-dark" href="<c:url value="/admins/lecturers/${a.id}" />">Cập nhật</a>
