<%-- 
    ...
    Created on : May 29, 2024, 4:57:42 PM
...
<h2 class="text-center m-2">Thêm <strong>SINH VIÊN</strong></h2>

<c:if test="${errorMessage != null}">
    <div class="alert alert-danger" role="alert">${errorMessage}</div>
</c:if>

<c:url value="/admins/students/add" var="act"/>
<form:form method="post" action="${act}" modelAttribute="student" enctype="multipart/form-data" onsubmit="return validatePassword()">
    ...
    <div class="form-floating mb-3" id="facultyInput">
        <form:select path="facultyId" id="facultyId" class="form-control" required="required" onchange="updateMajors()">
...
<script type="text/javascript">
    ...
    function updateClasses() {
        ...
        if (id) {
            ...
            majorSelect.innerHTML = '<option value="">Chọn lớp học</option>';
        }
    }
</script>
